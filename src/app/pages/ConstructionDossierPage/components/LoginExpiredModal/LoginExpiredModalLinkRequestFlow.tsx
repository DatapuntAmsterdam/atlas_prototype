...
export interface LoginExpiredModalLinkRequestFlowProps {
  email: string
  onRetry: () => void
  onClose: () => void
}

const LoginExpiredModalLinkRequestFlow: FunctionComponent<LoginExpiredModalLinkRequestFlowProps> =
  ({ email, onRetry, onClose }) => {
...
export default LoginExpiredModalLinkRequestFlow
