...
import { fetchMapBaseLayers, getUrlTemplate } from '../../../map/ducks/base-layers/map-base-layers'
import { fetchMapLayers, getLayers } from '../../../map/ducks/layers/map-layers'
import { fetchPanelLayers } from '../../../map/ducks/panel-layers/map-panel-layers'
import { isDrawingActive } from '../../../map/services/draw-tool/draw-tool'
import {
  getCenter,
  getDrawingMode,
  getMapZoom,
...
import getCrs from '../../../map/services/crs-service'
...
class LeafletContainer extends React.Component {
  ...
  handleClick(event) {
    ...
    if (!isDrawingActive(drawingMode) && !isLoading) {
      // TODO: Add new hook to get detail
      alert('clicker de klik')
