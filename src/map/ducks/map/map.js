...
const MAP_BOUNDING_BOX = 'MAP_BOUNDING_BOX';
export const MAP_BOUNDING_BOX_SILENT = 'MAP_BOUNDING_BOX_SILENT';
const MAP_CLEAR_DRAWING = 'MAP_CLEAR_DRAWING';
...
const SET_MAP_BASE_LAYER = 'SET_MAP_BASE_LAYER';
const TOGGLE_MAP_OVERLAY = 'TOGGLE_MAP_OVERLAY';
const TOGGLE_MAP_OVERLAY_VISIBILITY = 'TOGGLE_MAP_OVERLAY_VISIBILITY';
