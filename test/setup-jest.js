...
global.setExpiredAuthentication = () => {
  global.sessionStorage.setItem('accessToken', global.expiredToken)
}

global.setValidAuthentication = () => {
  global.sessionStorage.setItem('accessToken', global.validToken)
}

global.setInvalidAuthentication = () => {
  global.sessionStorage.setItem('accessToken', global.invalidToken)
}
